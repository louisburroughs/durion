...
ADR-0031, ADR-0032, ADR-0033, ADR-0034, ADR-0035, ADR-0037, ADR-0038, ADR-0039, ADR-0041, ADR-0062, ADR-0063, ADR-0064, ADR-0065.
...
| `mutation-check-hook.sh --repo <path> --module <mod> --file <f> --find <text> --replace <text> --test <sel>` | Prove a test defends its guarantee: asserts the mutation applied, requires the test to FAIL, restores the file. For a method in a `@Nested` class the selector must be `Class$Nested#method` — `Class#method` matches nothing. Finds a JDK 25 itself (`$JAVA_HOME`, `$HOME/.jdk/jdk-25*`, `/opt/jdk25`, `/usr/lib/jvm/*25*`); pass `--java-home` to override |
