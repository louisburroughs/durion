...
Cross-repo platform guidance for Claude Code. The canonical engineering policy lives in `AGENTS.md`; read that first. This file adds Claude Code-specific context, command discovery, and hook references.
...
**Pre-production policy** — prioritize clean, correct code over backward-compatibility workarounds. Remove deprecated members; do not add migration shims unless explicitly requested.
...
Minimum for backend work: ADR-0011, ADR-0013, ADR-0014, ADR-0017, ADR-0018, ADR-0023, ADR-0024, ADR-0026, ADR-0027.
Minimum for frontend work: ADR-0010, ADR-0029, ADR-0030, ADR-0031, ADR-0032, ADR-0033, ADR-0034, ADR-0035, ADR-0037, ADR-0038.
...
**Domain context** (`.claude/agents/domains/`):
accounting, audit, billing, crm, inventory, location, nlti, order, people, positivity, pricing, product, security, shopmgmt, workexec.
...
Branch naming: `cap/<cap-id>-<short-slug>` (preferred) or `feat/<short-slug>`.
PR titles: `[CAP:<cap-id>] <short summary>`.
