...
[Canonical ADR](https://github.com/louisburroughs/durion/blob/master/docs/adr/0004-crm-duplicate-detection.adr.md) — `docs/adr/0004-crm-duplicate-detection.adr.md`
