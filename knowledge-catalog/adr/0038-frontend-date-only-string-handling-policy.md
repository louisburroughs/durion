...
[Canonical ADR](https://github.com/louisburroughs/durion/blob/master/docs/adr/0038-frontend-date-only-string-handling-policy.adr.md) — `docs/adr/0038-frontend-date-only-string-handling-policy.adr.md`
