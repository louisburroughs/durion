...
[Canonical ADR](https://github.com/louisburroughs/durion/blob/master/docs/adr/0052-supplier-outbound-idempotency-duplicate-order-prevention.adr.md) — `docs/adr/0052-supplier-outbound-idempotency-duplicate-order-prevention.adr.md`
