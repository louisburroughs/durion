...
resource: https://github.com/louisburroughs/durion/blob/master/docs/adr/0031-frontend-mutation-error-state-convention.adr.md
path: durion/docs/adr/0031-frontend-mutation-error-state-convention.adr.md
tags: [adr, frontend]
status: stable
...
[Canonical ADR](https://github.com/louisburroughs/durion/blob/master/docs/adr/0031-frontend-mutation-error-state-convention.adr.md) — `docs/adr/0031-frontend-mutation-error-state-convention.adr.md`
