...
[Canonical ADR](https://github.com/louisburroughs/durion/blob/master/docs/adr/0056-platform-global-exception-handling.adr.md) — `docs/adr/0056-platform-global-exception-handling.adr.md`
