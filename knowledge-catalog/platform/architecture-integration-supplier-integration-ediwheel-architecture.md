...
title: Supplier Integration Architecture — EDIWheel and Beyond
description: '*Status:** ACCEPTED DIRECTION — open questions resolved 2026-08-10 (see §12); shipment tracking withdrawn 2026-08-14 (§12, decision 11)'
resource: https://github.com/louisburroughs/durion/blob/master/docs/architecture/integration/SUPPLIER_INTEGRATION_EDIWHEEL_ARCHITECTURE.md
