...
title: Agent Consolidation, Knowledge Catalog, and Doc Slimming Implementation Plan
description: '*Goal:** Consolidate shared agent configuration under durion, establish an OKF knowledge catalog for the Durion repos, slim repo docs to quick-start references, and add per-module index navigation ...'
resource: https://github.com/louisburroughs/durion/blob/master/docs/superpowers/plans/2026-08-19-agent-consolidation-knowledge-catalog.md
