...
title: 'Plan: Restore pos-mcp-server Tool Facades to Their Established Purpose'
description: '*Source issue:** durion-positivity-backend#1519 (see the analysis comment for the evidence trail)'
resource: https://github.com/louisburroughs/durion/blob/master/docs/superpowers/plans/2026-08-26-issue-1519-facade-restoration-plan.md
