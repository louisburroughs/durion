...
title: Roles, JWT, and Permissions Implementation Plan
description: '*Version: 1.0 Status: Active Last Updated: 2026-04-12 Related:** ADR-0040 Roles, JWT Claims, and Permission Governance Policy'
resource: https://github.com/louisburroughs/durion/blob/master/docs/architecture/plans/roles-jwt-permissions-implementation-plan.md
