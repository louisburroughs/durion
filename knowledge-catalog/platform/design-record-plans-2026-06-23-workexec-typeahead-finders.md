...
title: Workexec Typeahead Finders Implementation Plan
description: '*Goal:** Replace raw-id entry on /app/workexec with two typeahead finders (Find Estimate / Find Workorder) that search by customer name or record id/number and navigate to the selected record.'
resource: https://github.com/louisburroughs/durion/blob/master/docs/superpowers/plans/2026-06-23-workexec-typeahead-finders.md
