...
| 0002 | CRM Domain Permission Taxonomy and Authorization Model | DEPRECATED (superseded by 0025) | '2026-01-23' |
| 0003 | CRM Navigation Patterns | ACCEPTED | '2026-01-23' |
| 0004 | Duplicate Detection UX Strategy | ACCEPTED | '2026-01-23' |
| 0005 | Optimistic Locking Conflict Resolution | ACCEPTED | '2026-01-24' |
| 0006 | WorkExec - Domain Ownership Boundaries for WorkExec Features | ACCEPTED | '2026-01-25' |
| 0007 | WorkExec - Digital Customer Approval - Clarification Response | ACCEPTED | '2026-01-08' |
| 0008 | Inventory/Accounting - Cost Maintenance Architecture - Visual Guide - Clarification Response | SUPERSEDED BY 0048 | '2026-01-13' |
| 0009 | Backend Domain Responsibilities Guide | ACCEPTED | '2026-01-29' |
| 0010 | Frontend Domain Responsibilities Guide | ACCEPTED | '2026-03-28' |
| 0011 | API Gateway Security Architecture | ACCEPTED | '2026-02-01' |
| 0012 | Vehicle-Party Relationships Belong in pos-customer | ACCEPTED | '2026-02-03' |
| 0013 | UUID v7 Identifier Strategy for Platform Entities | ACCEPTED | '2026-02-07' |
| 0014 | Internal Service Security via Gateway Route Control | — | '2026-02-14' |
| 0015 | Person, Customer, and User Entity Semantics and Relationships | ACCEPTED | '2026-02-17' |
| 0016 | Location Entity Semantics and Definitions | ACCEPTED | '2026-02-17' |
| 0017 | API Controller HTTP Response Codes Standard | ACCEPTED | '2026-02-17' |
| 0018 | Audit Actor Fields from Security Context as Strings | ACCEPTED | '2026-02-18' |
| 0019 | Persistence Strategy for Short-Lived Operational State | ACCEPTED | '2026-02-19' |
| 0020 | Centralized Document Creation via pos-documents Service | ACCEPTED | '2026-02-19' |
| 0021 | Tax API Consumption and Internal Access Policy | ACCEPTED | '2026-02-21' |
| 0022 | Audit Stable Person Identifier Claim Policy | ACCEPTED | '2026-02-21' |
| 0023 | Remove tenantId and Adopt Single-Organization Context | SUPERSEDED BY 0062 | '2026-02-21' |
| 0024 | Entity createdAt/updatedAt Population Policy | ACCEPTED | '2026-02-23' |
| 0025 | Permissions Manifest (`permissions.yaml`) Registration Policy | ACCEPTED | '2026-02-26' |
| 0026 | Service Contract Boundary Policy (All Backend Modules) | ACCEPTED | '2026-02-26' |
...
| 0031 | Frontend Mutation Error State Convention | ACCEPTED | '2026-03-29' |
| 0032 | Frontend Test Fixture Interface Conformity | ACCEPTED | '2026-03-29' |
| 0033 | Angular Effect Observable Cancellation Policy | ACCEPTED | '2026-03-29' |
| 0034 | Frontend Server-Generated Field Omission Policy | ACCEPTED | '2026-03-29' |
| 0035 | Frontend Service Method Minimum Test Coverage | ACCEPTED | '2026-03-29' |
| 0036 | Frontend Security Audit Model Ownership Boundary | ACCEPTED | '2026-03-30' |
| 0037 | Frontend SPA Navigation Policy | ACCEPTED | '2026-04-02' |
| 0038 | Frontend Date-Only String Handling Policy | ACCEPTED | '2026-04-02' |
...
| 0046 | Environment Log Level Policy | ACCEPTED | '2026-07-12' |
| 0047 | Ledger Inalterability and Fiscal Positions Are Accounting Non-Goals | ACCEPTED | '2026-07-17' |
| 0048 | Inventory-Owned Valuation with Configurable Costing Method | ACCEPTED (supersedes 0008) | '2026-07-23' |
...
| 0054 | Sell-Price System of Record Split (pos-price Quoting, pos-catalog List/MSRP Reference) | ACCEPTED | '2026-08-10' |
...
| 0008 | Superseded by 0048; historical only. Item cost is computed and owned by pos-inventory; never build cost calculation or REST cost writes in accounting                                                                                                                                                                                                                                                                                                                                                 | Coder, Test, Planner, Orchestrator |
...
6. Run `python3 scripts/adr_okf_frontmatter.py` — it fills in your ADR's frontmatter and regenerates the Current ADRs table from it. Do not edit that table by hand.
