...
| 0048   | Inventory-Owned Valuation with Configurable Costing Method | PROPOSED              | 2026-07-22 |
...
| 0047 | Any proposal to add ledger hash-chaining/tamper-evidence or per-counterparty account substitution (fiscal positions) to pos-accounting — both are recorded non-goals with revisit triggers | Planner, Coder |
| 0048 | Inventory costing/valuation work: item cost sources, COGS on consumption, cost-bearing inventory facts, costing-method configuration, revaluation flows (pos-inventory owns valuation; accounting consumes facts) | Planner, Coder, Test |
