...
**Related:** ADR-0040 Roles, JWT Claims, and Permission Governance Policy

---

## Purpose

This plan operationalizes ADR-0040 across platform repositories so token contracts,
frontend UX gating, and backend authorization behavior remain consistent.
