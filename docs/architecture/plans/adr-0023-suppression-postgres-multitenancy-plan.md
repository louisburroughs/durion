...
| WS3 | Per-module retrofit x 27. Schema done 2026-09-09 (Appendix B). Done 2026-09-10: `pos-inventory` (#1928), `pos-accounting` (#1929), `pos-workorder` + `pos-catalog` (#1930), **wave 5 `pos-shop-manager` + `pos-order`** (#1931). Next, largest first: `pos-customer`, `pos-supplier`, `pos-warranty`, `pos-people`, `pos-invoice`, then the small modules | backend | 8 - 11 (spent ~2) | WS1, WS2 |
