...
| WS3 | Per-module retrofit x 27. Schema done 2026-09-09 (Appendix B). Done 2026-09-10: wave 1 `pos-inventory` (backend #1928), wave 2 `pos-accounting` (#1929), waves 3 and 4 `pos-workorder` and **`pos-catalog`** (#1930: 42 scoped entities, outbox `tenant_id`, both jobs platform-scoped). Next, largest first: the medium modules (`pos-customer`, `pos-invoice`, `pos-people`, ...) | backend | 8 - 11 (spent ~2) | WS1, WS2 |
