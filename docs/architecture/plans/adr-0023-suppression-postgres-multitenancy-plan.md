...
| WS3 | Per-module retrofit x 27. Schema done 2026-09-09 (baseline flatten, Appendix B). **Wave 1 done 2026-09-10: `pos-inventory`** (backend #1928: entities, outbox header, schedulers classified, native queries audited, `pos_app`, isolation ITs). Next, largest first: `pos-accounting`, `pos-workorder`, `pos-catalog`, then the medium and small modules | backend | 8 - 11 (spent ~0.5) | WS1, WS2 |
