...
| WS3 | Per-module retrofit x 27. Schema done 2026-09-09 (Appendix B). Wave 1 done 2026-09-10: `pos-inventory` (backend #1928). **Wave 2 done 2026-09-10: `pos-accounting`** (backend #1929: 59 scoped entities, both outboxes carry `tenant_id`, processor binds per row, seeder per tenant). Next, largest first: `pos-workorder`, `pos-catalog`, then the rest | backend | 8 - 11 (spent ~1) | WS1, WS2 |
