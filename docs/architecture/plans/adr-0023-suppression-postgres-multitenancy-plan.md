...
| WS3 | Per-module retrofit x 27. Schema done 2026-09-09 (Appendix B). Done 2026-09-10: waves 1-7 (backend #1928-#1932, 8 modules), **waves 8-11 (backend #1934): warranty, people, invoice, marketing, vehicle-inventory, price, vehicle-fitment, people-contact, tax, image, nhtsa, carapi**. Left: mcp-server, event-receiver (emitter must carry the tenant), bulk-loader (WS8) | backend | 8 - 11 (spent ~2) | WS1, WS2 |
