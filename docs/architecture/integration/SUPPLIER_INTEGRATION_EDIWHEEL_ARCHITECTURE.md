...
| MKCAT enrichment is published but nothing attaches it to products | [#1352](https://github.com/louisburroughs/durion-positivity-backend/issues/1352) | **SHIPPED** (PR #1359): attachment model, `supplier.catalog.updated` consumer, trigram matcher, two reads. #1645 also **SHIPPED**, in [PR #1846](https://github.com/louisburroughs/durion-positivity-backend/pull/1846): confidence tiers, ambiguity parking, resolve contract ([ADR-0060](../../adr/0060-catalog-enrichment-matching.adr.md)) |
