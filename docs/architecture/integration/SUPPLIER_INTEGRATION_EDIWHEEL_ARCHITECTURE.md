...
| MKCAT enrichment is published but nothing attaches it to products | [#1352](https://github.com/louisburroughs/durion-positivity-backend/issues/1352) | **SHIPPED** — PR #1359 (2026-08-17): `TreadDesignEntity`, `product.tread_design_id`, a `supplier.catalog.updated` consumer, a single-threshold trigram matcher and the two tread-design reads. [#1645](https://github.com/louisburroughs/durion-positivity-backend/issues/1645) / [ADR-0060](../../adr/0060-catalog-enrichment-matching.adr.md) extend it in place with confidence tiers, ambiguity parking and a review/resolve contract |
