...
| MKCAT enrichment is published but nothing attaches it to products | [#1352](https://github.com/louisburroughs/durion-positivity-backend/issues/1352) | **SHIPPED** in PR #1359 (2026-08-17): attachment model, `supplier.catalog.updated` consumer, trigram matcher, two reads. #1645 / [ADR-0060](../../adr/0060-catalog-enrichment-matching.adr.md) add confidence tiers, ambiguity parking and a review/resolve contract |
