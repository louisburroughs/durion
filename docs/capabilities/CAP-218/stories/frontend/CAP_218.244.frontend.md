...
### Dependencies
- **Domain ownership/orchestration choice (blocking):** This story describes a Work Order fulfillment workflow (“pick list”, “pick task”, “pick line”, “complete picking”) that is likely owned by **Work Execution**. The remaining blocker is confirming the canonical frontend API surface and route placement.
