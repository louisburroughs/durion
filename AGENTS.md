...
- `durion`: workspace-level coordination, governance, and agent docs
...
## Quick Prerequisites
- Java 21+ (for Moqui runtime and Spring Boot services)
...
## Code Style & Quality
- Java/Groovy: follow existing Moqui conventions. Keep controllers thin; place logic in service classes.
...
- Preface PR titles with the affected area: `[moqui]`, `[pos-order]`, `[infra]`, etc.
