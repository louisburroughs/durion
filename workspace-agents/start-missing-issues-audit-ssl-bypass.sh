...
# Production Missing Issues Audit System with SSL Bypass
...
# Start the audit system with SSL bypass using Maven exec plugin
MAVEN_OPTS="-Dtrust_all_cert=true" mvn exec:java -Dexec.mainClass="com.durion.audit.MissingIssuesAuditMain" -Dexec.args="$*" -q