...
public class WorkspaceAgentDeploymentManager {
    ...
    public CompletableFuture<PackagingResult> packageAgent(String agentId, PackagingOptions options) {
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                return DeploymentResults.PackagingResult.success(agentPackage);
                
            } catch (Exception e) {
                statistics.recordPackaging(agentId, false);
                return DeploymentResults.PackagingResult.failure("Packaging failed: " + e.getMessage());
            } finally {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                if (!validation.isValid()) {
                    ...
                    return DeploymentResults.DeploymentResult.failure("Environment validation failed: " + validation.getErrorMessage());
                }
     ...
     */
    public CompletableFuture<DeploymentResults.UninstallResult> uninstallAgent(String agentId, DeploymentOptions.UninstallOptions options) {
        return CompletableFuture.supplyAsync(() -> {
            try {
                deploymentLock.writeLock().lock();
     ...
     */
    public CompletableFuture<DeploymentResults.FailoverResult> triggerFailover(String agentId, DeploymentOptions.FailoverOptions options) {
     ...
     */
    public CompletableFuture<DeploymentResults.DisasterRecoveryResult> initiateDisasterRecovery(DeploymentOptions.DisasterRecoveryOptions options) {
