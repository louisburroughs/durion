...
public class WorkspaceArchitectureAgent implements WorkspaceAgent {
    ...
    private final core.WorkspaceAgentRegistry registry;

    public WorkspaceArchitectureAgent() {
        this.registry = new core.WorkspaceAgentRegistry();
    }

    public WorkspaceArchitectureAgent(core.WorkspaceAgentRegistry registry) {
        this.registry = registry != null ? registry : new core.WorkspaceAgentRegistry();
    }
    ...
    public ArchitecturalConsistencyResult validateArchitecturalConsistency(java.util.List<interfaces.ArchitecturalDecision> decisions) {
    ...
    public ApiContractCompatibilityResult validateApiContractCompatibility(java.util.List<interfaces.ApiContract> contracts) {
    ...
    public JwtFormatConsistencyResult validateJwtFormatConsistency(java.util.List<interfaces.JwtFormat> formats) {
        ...
        for (interfaces.JwtFormat f : formats) {
    ...
    public DependencyConflictResult validateDependencyConflicts(java.util.List<interfaces.DependencyConflict> conflicts) {
        java.util.List<String> present = conflicts == null ? java.util.Collections.<String>emptyList() : conflicts.stream()
                .filter(interfaces.DependencyConflict::isConflict)
