...
This domain exposes **5** REST API endpoints:
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `customerTierId` | string (uuid) | Yes |  |
| `effectiveTimestamp` | string (date-time) | No |  |
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `extendedPrice` | string | No |  |
| `msrp` | string | No |  |
| `priceSource` | string | No |  |
| `pricingBreakdown` | array | No |  |
