...
title: Accounting ERD Before Multitenancy
description: Historical physical schema diagram predating the current tenant-aware baseline; not the current database model.
status: historical
source: https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/pos-accounting-erd.md
reconciled: 2026-09-16
---

> **Status: historical.** This snapshot contains 33 tables versus 62 in the reviewed baseline, omits tenant_id and many newer tables, and still includes obsolete reconciliation. Use current DDL for the physical schema and DOMAIN_MODEL.md for the conceptual model.
> See the [reconciled implementation reference](../implementation-reference.md) and
> [canonical accounting index](../index.md).

Original source: [backend documentation at e5d7ec82e](https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/pos-accounting-erd.md).
...
# Accounting ERD — Historical Snapshot
