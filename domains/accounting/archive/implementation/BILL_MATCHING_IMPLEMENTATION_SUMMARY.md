...
title: Bill Matching Implementation Summary
description: Historical bill matching delivery report; use the reconciled implementation reference for current scoring and approval behavior.
status: historical
source: https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/BILL_MATCHING_IMPLEMENTATION_SUMMARY.md
reconciled: 2026-09-16
---

> **Status: historical.** Scoring and approval claims below are a historical snapshot. Current scoring tops out at 95; confidence alone does not approve a bill. The partial-match Jaccard example is incorrect: two shared products out of four distinct products give 50%, or 15 points.
> See the [reconciled implementation reference](../../implementation-reference.md) and
> [canonical accounting index](../../index.md).

Original source: [backend documentation at e5d7ec82e](https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/BILL_MATCHING_IMPLEMENTATION_SUMMARY.md).
