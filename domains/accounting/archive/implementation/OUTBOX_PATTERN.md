...
title: Event Outbox Pattern Implementation
description: Historical in-process outbox guide; current accounting has separate local and Kafka outboxes with different retry behavior.
status: historical
source: https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/OUTBOX_PATTERN.md
reconciled: 2026-09-16
---

> **Status: historical.** This February 2026 report covers only the local event_outbox. Its production-ready label, unlimited retry and FIFO claims are historical assertions, not verified current guarantees. Accounting now also has a Kafka outbox.
> See the [reconciled implementation reference](../../implementation-reference.md) and
> [canonical accounting index](../../index.md).

Original source: [backend documentation at e5d7ec82e](https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/OUTBOX_PATTERN.md).
