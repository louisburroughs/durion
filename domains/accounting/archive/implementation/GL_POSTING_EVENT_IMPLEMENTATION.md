...
description: Historical vendor-bill event report; the current handler submits accounting events but submission is not journal posting.
status: historical
source: https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/GL_POSTING_EVENT_IMPLEMENTATION.md
reconciled: 2026-09-16
---

> **Status: historical.** The handler is no longer a skeleton. It submits an accounting event for ingestion. The publisher still dispatches directly in process; the asynchronous-delivery and failure-isolation claims below are not current guarantees.
> See the [reconciled implementation reference](../../implementation-reference.md) and
> [canonical accounting index](../../index.md).

Original source: [backend documentation at e5d7ec82e](https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/GL_POSTING_EVENT_IMPLEMENTATION.md).
