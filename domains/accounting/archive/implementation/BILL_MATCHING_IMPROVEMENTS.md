...
title: Bill Matching Improvements
description: Historical bill matching improvement report and roadmap, with implemented follow-ups distinguished in the current reference.
status: historical
source: https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/BILL_MATCHING_IMPROVEMENTS.md
reconciled: 2026-09-16
---

> **Status: historical.** The roadmap below is historical: candidate persistence and manual selection now exist.
> See the [reconciled implementation reference](../../implementation-reference.md) and
> [canonical accounting index](../../index.md).

Original source: [backend documentation at e5d7ec82e](https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/BILL_MATCHING_IMPROVEMENTS.md).
