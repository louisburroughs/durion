...
title: Accounting Flyway Baseline Reset Plan
description: Superseded baseline-reset plan retained as history; current migrations and tenancy guidance take precedence.
status: superseded
source: https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/flyway-baseline-reset-plan.md
reconciled: 2026-09-16
---

> **Status: superseded.** The named V1__baseline_accounting_schema.sql is obsolete. Do not execute this historical reset recipe as a current runbook; use the active migration and operations references in the reconciled guide.
> See the [reconciled implementation reference](../implementation-reference.md) and
> [canonical accounting index](../index.md).

Original source: [backend documentation at e5d7ec82e](https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/flyway-baseline-reset-plan.md).
