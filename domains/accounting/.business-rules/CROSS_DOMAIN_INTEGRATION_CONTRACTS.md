...
| **inventory.product-value.changed** | pos-inventory (`ProductValueChangedV1`, `inventory.events.v1`) | Manual cost revaluation applied (odoo-parity J4) | {revaluationId, sku, costingMethod, previousUnitCost, newUnitCost, onHandQuantity, totalValueDelta, reason, actor, occurredAt} | Revaluation of Inventory (1300) by `totalValueDelta` against a gain/loss account (owner decision D7) | 🟨 Producer live, consumer missing |
