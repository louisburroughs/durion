...
title: Double-Entry Bookkeeping and Core Accounting Principles
description: Conceptual bookkeeping material for natural-language reasoning; examples do not define executable posting or permission contracts.
status: reference
source: https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/de-bookkeeping-rag.md
reconciled: 2026-09-16
---

> **Status: reference.** This is conceptual, non-normative material. Example accounts, event names, permissions and entries are illustrative; current business rules, posting rules and accepted ADRs govern implementation.
> See the [reconciled implementation reference](../implementation-reference.md) and
> [canonical accounting index](../index.md).

Original source: [backend documentation at e5d7ec82e](https://github.com/louisburroughs/durion-positivity-backend/blob/e5d7ec82e6970b6de3ee36ef45a4d1a32fc9fd31/pos-accounting/docs/de-bookkeeping-rag.md).
Source-relative code paths and recorded test results below describe the original backend checkout and delivery, not checks run during this move.

The separately maintained [packaged MCP RAG resource](https://github.com/louisburroughs/durion-positivity-backend/blob/main/pos-mcp-server/src/main/resources/rag/de-bookkeeping-rag.md)
is runtime content, not another canonical documentation location. This move does not replace or reload that resource.
