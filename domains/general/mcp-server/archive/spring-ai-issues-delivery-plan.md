---
type: Plan
title: pos-mcp-server — Spring AI Issues Delivery Plan
domain: general
status: historical
...
- `domains/general/mcp-server/archive/gate3-openapi-bridge-design.md`, `domains/general/mcp-server/archive/gate5-rag-hybrid-design.md`,
  `domains/general/mcp-server/archive/gate7-admin-observability-design.md`, `domains/general/mcp-server/archive/phase0-fixtures-and-telemetry.md`.
- `domains/general/mcp-server/archive/spring-ai-big-bang-migration-checklist.md` — the LangChain4j → Spring AI cutover.
