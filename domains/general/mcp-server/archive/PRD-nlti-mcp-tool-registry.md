---
type: PRD
title: 'PRD: Natural Language Task Interface (NLTI) + MCP Tool Registry'
domain: general
status: historical
...
| File | Purpose |
|------|---------|
| `pos-mcp-server/docs/tool-registry-plan.md` (removed before the Spring AI migration) | Execution checklist and decision log for MCP registry |
| `pos-mcp-server/docs/tool-registry-implementation.md` (removed before the Spring AI migration) | Reference implementation: entities, repositories, scorer |
| `pos-mcp-server/docs/tool-audit-logging.md` (removed before the Spring AI migration) | Audit schema, aggregated performance view, priority formula |
| `pos-mcp-server/docs/domain-facade-tools.md` (removed before the Spring AI migration) | Facade tool list, intent routing, role-based registration design |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-001-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-001-backend.md) | NLTI Foundation story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-002-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-002-backend.md) | Intent model story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-003-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-003-backend.md) | Tool registry story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-004-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-004-backend.md) | Planning engine story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-005-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-005-backend.md) | Execution orchestrator story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-006-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-006-backend.md) | Confirmation gate story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-007-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-007-backend.md) | Audit trail story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-008-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-008-backend.md) | Domain tool adapters story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-009-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-009-backend.md) | Observability story |
| [durion/scripts/nlti/durion-positivity-backend/NLTI-010-backend.md](../../../../scripts/nlti/durion-positivity-backend/NLTI-010-backend.md) | Guidance mode story |
| [durion-positivity-backend/AGENTS.md](https://github.com/louisburroughs/durion-positivity-backend/blob/main/AGENTS.md) | Backend conventions (packages, events, null safety) |
