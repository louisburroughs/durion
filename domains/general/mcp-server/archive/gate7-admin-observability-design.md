---
type: Design
title: Gate 7 — Admin Tooling, Dashboards, Tuning Controls (design)
domain: general
status: historical
...
- `AuditLedgerService`; existing `domains/general/mcp-server/operations/dashboards/nlti-overview.md`, `domains/general/mcp-server/operations/alerts/nlti-alerts.md`,
  `docs/runbooks/*`.
...
- Dashboard panels (extend `domains/general/mcp-server/operations/dashboards/nlti-overview.md`): routing decisions, model-tier usage,
...
## G7.3 — Alerts (`domains/general/mcp-server/operations/alerts/nlti-alerts.md`, Prometheus rules)
