...
`domains/general/mcp-server/archive/spring-ai-big-bang-migration-checklist.md` (now `status: complete`, final decision
**PASS (de facto)**).
...
`domains/general/mcp-server/archive/spring-ai-issues-delivery-plan.md` (`4a182ac59`).
