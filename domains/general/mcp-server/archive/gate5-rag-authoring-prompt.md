---
type: Authoring Artifact
title: Agent Prompt — Author Gate 5 RAG Documents (pos-mcp-server)
domain: general
status: historical
...
Authoritative spec for this task: `domains/general/mcp-server/archive/gate5-rag-hybrid-design.md` (§G5.5 + the doc
