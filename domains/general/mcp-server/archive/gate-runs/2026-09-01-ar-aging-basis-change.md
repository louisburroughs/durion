...
title: A/R aging basis change invalidates the Q13 and Q5 records — 2026-09-01
domain: general
status: historical
...
3. **Re-run Q13 and Q5 on a live stack** (alpha or a docker-profile stack with fixture data and a running
   embedding model — see `domains/general/mcp-server/archive/gate-runs/wave-2/README.md` for what that requires) and record the
