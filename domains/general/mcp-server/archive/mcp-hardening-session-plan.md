---
type: Plan
title: MCP Hardening — Working Session Plan
domain: general
status: historical
...
- **Metrics + alerting + runbook: done.** Counters `tools.discovered` / `tools.registered` (both
  incremented); `domains/general/mcp-server/operations/alerts/tool-discovery-alerts.md`; `domains/general/mcp-server/operations/runbooks/tool-discovery-failure.md`.
...
- #779: Gate 3 live-stack verification per `domains/general/mcp-server/archive/gate3-openapi-bridge-design.md`.
