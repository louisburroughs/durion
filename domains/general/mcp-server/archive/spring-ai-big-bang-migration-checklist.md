...
> `domains/general/mcp-server/archive/spring-ai-migration-review.md` for the post-migration review.
...
- [x] Post-migration review document is published with lessons learned. — _ev: `domains/general/mcp-server/archive/spring-ai-migration-review.md` (2026-08-07, #1197)._
