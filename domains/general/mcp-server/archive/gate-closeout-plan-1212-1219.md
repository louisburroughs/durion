---
type: Plan
title: Gate Close-Out Execution Plan (#1212–#1219)
domain: general
status: historical
...
2. Gate 7 dashboards don't exist. `domains/general/mcp-server/operations/dashboards/nlti-overview.md` has 8 request-health panels;
...
| 0.5 | Dashboard JSON + extend `domains/general/mcp-server/operations/dashboards/nlti-overview.md` with the missing routing/tier/fallback/RAG/prompt-layer/write-gate panels; cross-check `domains/general/mcp-server/operations/alerts/nlti-alerts.md` covers the 7 required alerts | **#1368**, feeds #1219 |
