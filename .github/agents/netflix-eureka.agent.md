...
---
Here is a comprehensive agent description for a Netflix Eureka Server Expert, formatted in Markdown to match the style of your Spring Boot 4.0.x persona.
