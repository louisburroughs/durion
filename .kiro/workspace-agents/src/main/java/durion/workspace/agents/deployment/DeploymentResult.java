...
public class DeploymentResults {
    ...
    public static class PackagingResult {
        ...
        private PackagingResult(boolean success, AgentPackage agentPackage, String errorMessage) {
        ...
        public AgentPackage getAgentPackage() { return agentPackage; }
    ...
    public static class DeploymentResult {
        ...
        public boolean isSuccess() { return success; }
        public DeployedAgent getDeployedAgent() { return deployedAgent; }
        public String getErrorMessage() { return errorMessage; }
    }
    ...
    public static class UpdateResult {
        ...
        private UpdateResult(boolean success, DeployedAgent updatedAgent, DeployedAgent backupAgent, String errorMessage) {
            this.success = success;
        ...
        public boolean isSuccess() { return success; }
        public DeployedAgent getUpdatedAgent() { return updatedAgent; }
        public DeployedAgent getBackupAgent() { return backupAgent; }
        public String getErrorMessage() { return errorMessage; }
    }
    ...
    public static class DisasterRecoveryResult {
        ...
        public List<String> getRecoveredAgents() { return recoveredAgents; }
        public String getErrorMessage() { return errorMessage; }
    ...
    public static class BackupResult {
        ...
        public boolean isSuccess() { return success; }
        public Map<String, BackupRecord> getBackups() { return backups; }
    ...
    public static class RestoreResult {
        ...
        public boolean isSuccess() { return success; }
        public DeployedAgent getRestoredAgent() { return restoredAgent; }
        public String getErrorMessage() { return errorMessage; }
    }
}