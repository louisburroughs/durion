...
public class ObservabilityUnificationTest {
    ...
    void shouldProvideCorrelationAcrossTechnologies(
        ...
        // Then: System should identify correlations across technologies
        if (correlatedMetrics.hasActualCorrelations()) {
            ...
            Assertions.assertFalse(analysis.getCorrelatedMetricPairs().isEmpty(), 
                "Correlated metric pairs should be identified");
            
            // Verify cross-technology correlations are detected
            Assertions.assertTrue(analysis.hasCrossTechnologyCorrelations(), 
                "Cross-technology correlations should be detected");
        }
        
        // Unified view should always be provided regardless of correlations
